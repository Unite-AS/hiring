...
- A proactive mindset that dares to challenge established truths.
- Experience with React Native and Expo is a significant plus, but not a requirement.
- The ability to bridge the gap between technical complexity and business needs, communicating solutions clearly to non-technical stakeholders.
- A results-oriented approach driven by creating value, with a sense of ownership over the product from code to deployment.
- Experience with CI/CD pipelines.
- A genuine desire to learn and grow professionally within a hybrid work environment.
...
We have customers in Norway and Sweden, and we have big ambitions for the coming years. Our typical customers are media houses such as Morgenbladet, Klassekampen, Vårt Land, Hegnar Media, Aller Media, Dagsavisen, as well as several other large and small media companies.
